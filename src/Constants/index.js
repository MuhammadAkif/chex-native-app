...
export const INSPECTION_SUBCATEGORY = {
  ...
  interior_driver_side: 'exteriorInteriorDriverSide',
  interior_driver_side_1: 'exteriorInteriorDriverSide_1',
  interior_driver_side_2: 'exteriorInteriorDriverSide_2',
  interior_passenger_side: 'exteriorInteriorPassengerSide',
  interior_passenger_side_1: 'exteriorInteriorPassengerSide_1',
  interior_passenger_side_2: 'exteriorInteriorPassengerSide_2',
